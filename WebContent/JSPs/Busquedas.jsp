...
<link rel="stylesheet" href="/prueba_trabajo/config/styles/main.css" />
		...
		<div class="top">
			...
			<div id="logo">
				<span class="image avatar48"><img
					src="/prueba_trabajo/config/images/avatar.jpg" alt="" /></span>
			...
			<nav id="nav">
				<ul>
					<li><a href="/controladorSesiones?id=3" id="contact-link"><span
							class="icon solid fa-envelope">Contactos</span></a></li>
					<li><a href="/JSPs/Inicio.jsp" id="top-link"><span
		...
		<section id="contact" class="four">
			<div class="container">
				<div class="container mt-3">
					...
					<form action="/Practica-1/src/ec/ups/edu/controlador/Buscar?id=1" method="POST">
					...
					<form action="/Practica-1/src/ec/ups/edu/controlador/Buscar?id=2" method="POST">
						<div class="input-group mb-3 input-group-sm">
							<div class="input-group-prepend">
					...
					<table class="table table-bordered">
						...
						<tbody id="myTable">
							...
							<c:forEach var="telf" items="${p1}">
								<tr>
									<td>${telf.nombre} ${telf.apellido}</td>
